...
export default function FilePatent() {
  ...
  return (
    <>
      <LoadingOverlay 
        isVisible={mutation.isPending} 
        message="Creating your patent..."
      />
                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            <FormControl>
                              <SelectTrigger data-testid="select-patent-category">
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              ...
                              data-testid="textarea-patent-description"
                              {...field}
                            />
                          </FormControl>
                          <FormDescription>
                      ...
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                        ...
                        <div className="mt-4">
                          ...
                          <input
                            ...
                            className="sr-only"
                            data-testid="input-patent-files"
                      ...
                      {selectedFiles.length > 0 && (
                        <div className="space-y-2">
                          ...
                          {selectedFiles.map((file, index) => (
                            <div key={index} className="flex items-center justify-between p-2 bg-gray-50 rounded" data-testid={`file-item-${index}`}>
                    ...
                    <div className="flex justify-end space-x-4">
                      ...
                      <Button 
                        ...
                        data-testid="button-submit-patent"
                      >
