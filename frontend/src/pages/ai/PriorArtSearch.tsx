  ...
  const searchMutation = useMutation({
    mutationFn: async (data: SearchFormValues) => {
      const payload = {
        ...
        ...(data.patentId && { patentId: data.patentId }),
      };
      
      const response = await apiRequest("POST", "/api/ai/prior-art-search", payload);
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} value={field.value}>
                          ...
                          <SelectContent>
                            <SelectItem value="">Manual description</SelectItem>
